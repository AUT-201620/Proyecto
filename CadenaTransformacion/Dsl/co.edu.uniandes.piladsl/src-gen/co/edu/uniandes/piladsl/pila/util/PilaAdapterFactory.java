...
public class PilaAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected PilaSwitch<Adapter> modelSwitch =
    new PilaSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseExpresionTerminal(ExpresionTerminal object)
      {
        return createExpresionTerminalAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link co.edu.uniandes.piladsl.pila.Operacion <em>Operacion</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link co.edu.uniandes.piladsl.pila.ExpresionTerminal <em>Expresion Terminal</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createExpresionTerminalAdapter()
  {
    return null;
  }
