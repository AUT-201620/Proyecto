...
public class PilaFactoryImpl extends EFactoryImpl implements PilaFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case PilaPackage.OPERACION: return createOperacion();
      case PilaPackage.EXPRESION_TERMINAL: return createExpresionTerminal();
   ...
   * @generated
   */
  public ExpresionTerminal createExpresionTerminal()
  {
    ExpresionTerminalImpl expresionTerminal = new ExpresionTerminalImpl();
