...
public class PilaSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PilaPackage.eINSTANCE)
			...
			case PilaPackage.EXPRESION_TERMINAL:
				sequence_ExpresionTerminal(context, (ExpresionTerminal) semanticObject); 
				return; 
	 ...
	 *         variables+=Variable* 
	 *         (asignacionVariable=[Variable|ID] expresionAsignacionVariable=Expresion)? 
	...
	/**
	 * Contexts:
	 *     ExpresionTerminal returns ExpresionTerminal
	 *
	 * Constraint:
	 *     (entero=INT | real=REAL | nombreCalificado=NombreCalificado)
	 */
	protected void sequence_ExpresionTerminal(ISerializationContext context, ExpresionTerminal semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Operacion(ISerializationContext context, Operacion semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, PilaPackage.Literals.OPERACION__IZQUIERDA) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PilaPackage.Literals.OPERACION__IZQUIERDA));
			if (transientValues.isValueTransient(semanticObject, PilaPackage.Literals.OPERACION__OPERADOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PilaPackage.Literals.OPERACION__OPERADOR));
			if (transientValues.isValueTransient(semanticObject, PilaPackage.Literals.OPERACION__DERECHA) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PilaPackage.Literals.OPERACION__DERECHA));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getOperacionAccess().getIzquierdaExpresionTerminalParserRuleCall_0_0(), semanticObject.getIzquierda());
		feeder.accept(grammarAccess.getOperacionAccess().getOperadorOperadorEnumRuleCall_1_0(), semanticObject.getOperador());
		feeder.accept(grammarAccess.getOperacionAccess().getDerechaExpresionTerminalParserRuleCall_2_0(), semanticObject.getDerecha());
		feeder.finish();
	}
