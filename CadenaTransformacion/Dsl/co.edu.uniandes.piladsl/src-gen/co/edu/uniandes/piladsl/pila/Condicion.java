 ...
 *   <li>{@link co.edu.uniandes.piladsl.pila.Condicion#getExpresionAsignacionVariable <em>Expresion Asignacion Variable</em>}</li>
...
public interface Condicion extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Expresion Asignacion Variable</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Expresion Asignacion Variable</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Expresion Asignacion Variable</em>' containment reference.
   * @see #setExpresionAsignacionVariable(Expresion)
   * @see co.edu.uniandes.piladsl.pila.PilaPackage#getCondicion_ExpresionAsignacionVariable()
   * @model containment="true"
   * @generated
   */
  Expresion getExpresionAsignacionVariable();

  /**
   * Sets the value of the '{@link co.edu.uniandes.piladsl.pila.Condicion#getExpresionAsignacionVariable <em>Expresion Asignacion Variable</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Expresion Asignacion Variable</em>' containment reference.
   * @see #getExpresionAsignacionVariable()
   * @generated
   */
  void setExpresionAsignacionVariable(Expresion value);
