...
public class PilaGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CondicionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cExpresionAssignment_3_2 = (Assignment)cGroup_3.eContents().get(2);
		private final RuleCall cExpresionExpresionParserRuleCall_3_2_0 = (RuleCall)cExpresionAssignment_3_2.eContents().get(0);
		...
		//	variables+=Variable* (asignacionVariable=[Variable] IGUAL expresion+=Expresion PTOCOMA)?
		...
		//(asignacionVariable=[Variable] IGUAL expresion+=Expresion PTOCOMA)? subCondiciones+=Condicion* ('retornar'
		//expresionRetorno=Expresion PTOCOMA)? LLAVED
		public Group getGroup() { return cGroup; }
		...
		//(asignacionVariable=[Variable] IGUAL expresion+=Expresion PTOCOMA)?
		...
		//expresion+=Expresion
		public Assignment getExpresionAssignment_3_2() { return cExpresionAssignment_3_2; }
		
		//Expresion
		public RuleCall getExpresionExpresionParserRuleCall_3_2_0() { return cExpresionExpresionParserRuleCall_3_2_0; }
	...
	public class ExpresionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cOperadorOperadorEnumRuleCall_1_0_0 = (RuleCall)cOperadorAssignment_1_0.eContents().get(0);
		private final Assignment cDerechasAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cDerechasExpresionTerminalParserRuleCall_1_1_0 = (RuleCall)cDerechasAssignment_1_1.eContents().get(0);
		...
		//(operador+=Operador derechas+=ExpresionTerminal)*
		...
		//Operador
		public RuleCall getOperadorOperadorEnumRuleCall_1_0_0() { return cOperadorOperadorEnumRuleCall_1_0_0; }
		
		//derechas+=ExpresionTerminal
		public Assignment getDerechasAssignment_1_1() { return cDerechasAssignment_1_1; }
		
		//ExpresionTerminal
		public RuleCall getDerechasExpresionTerminalParserRuleCall_1_1_0() { return cDerechasExpresionTerminalParserRuleCall_1_1_0; }
	}
	public class ExpresionTerminalElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cRealAssignment_1_0 = (Assignment)cGroup_1.eContents().get(0);
		private final RuleCall cRealINTTerminalRuleCall_1_0_0 = (RuleCall)cRealAssignment_1_0.eContents().get(0);
		...
		//	entero=INT | real=INT '.' INT | nombreCalificado=NombreCalificado
		@Override public ParserRule getRule() { return rule; }
		...
		//real=INT
		public Assignment getRealAssignment_1_0() { return cRealAssignment_1_0; }
		
		//INT
		public RuleCall getRealINTTerminalRuleCall_1_0_0() { return cRealINTTerminalRuleCall_1_0_0; }
