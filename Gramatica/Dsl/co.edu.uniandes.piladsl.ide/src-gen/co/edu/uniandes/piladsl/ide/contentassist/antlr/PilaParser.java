		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExpresionAccess().getGroup_1(), "rule__Expresion__Group_1__0");
					put(grammarAccess.getExpresionTerminalAccess().getGroup_1(), "rule__ExpresionTerminal__Group_1__0");
					...
					put(grammarAccess.getCondicionAccess().getExpresionAssignment_3_2(), "rule__Condicion__ExpresionAssignment_3_2");
					...
					put(grammarAccess.getExpresionAccess().getIzquierdaAssignment_0(), "rule__Expresion__IzquierdaAssignment_0");
					put(grammarAccess.getExpresionAccess().getOperadorAssignment_1_0(), "rule__Expresion__OperadorAssignment_1_0");
					put(grammarAccess.getExpresionAccess().getDerechasAssignment_1_1(), "rule__Expresion__DerechasAssignment_1_1");
					put(grammarAccess.getExpresionTerminalAccess().getEnteroAssignment_0(), "rule__ExpresionTerminal__EnteroAssignment_0");
					put(grammarAccess.getExpresionTerminalAccess().getRealAssignment_1_0(), "rule__ExpresionTerminal__RealAssignment_1_0");
